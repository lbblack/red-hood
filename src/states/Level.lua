...
local AttackShieldAISystem = require("src.systems.AttackShieldAISystem")
local ActiveHitboxSystem = require("src.systems.ActiveHitboxSystem")
local SkeletonAISystem = require("src.systems.SkeletonAISystem")
...
function Level:load()
	...
	local player = Player({x = 20, y = 100})
	...
	world:addSystem(AttackShieldAISystem(player))
	world:addSystem(UpdateSystem())
	world:addSystem(ActiveHitboxSystem())
	world:addSystem(SkeletonAISystem(player))
